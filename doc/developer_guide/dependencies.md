...
Maybe installing the command [chdist](https://manpages.org/chdist) could also be helpful, as it allows searching for packages and updates in other versions and distributions of ubuntu than the one installed on your local system.
