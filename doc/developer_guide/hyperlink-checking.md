...
|-------|------|-----------------------------|
| Markdown files, e.g. README or Changelog | GitHub action [lycheeverse/lychee-action](lycheeverse/lychee-action) | Add regexp to file [.lycheeignore](https://github.com/exasol/ai-lab/blob/main/.lycheeignore) |
